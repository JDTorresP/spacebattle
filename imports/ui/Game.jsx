...
componentDidMount() {
  ...
  update() {
    ...
    // Check for colisions
    // this.checkCollisionsWith(this.bullets, this.ship);
  ...
  startGame(){
    ...
    let ship = new Ship({
      position: {
        x: randomNumBetweenExcluding(0, this.state.screen.width, this.state.screen.width/2-60, this.state.screen.height/2+60),
